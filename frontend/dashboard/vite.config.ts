...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      // The shell embeds the chat build at these same-origin paths. In
      // development, forward them to the backend's built-frontend mounts.
      "/chat": "http://127.0.0.1:2236",
      "/settings": "http://127.0.0.1:2236",
      "/assets": "http://127.0.0.1:2236",
    },
  },
});
