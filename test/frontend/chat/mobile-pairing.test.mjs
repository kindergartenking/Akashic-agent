...
import { parsePairedDevice, parsePairingOffer, parsePairingStatus } from "../../../frontend/chat/src/mobile-pairing-data.ts";

const app = await readFile(new URL("../../../frontend/chat/src/desktop-chat-view.tsx", import.meta.url), "utf8");
const dialog = await readFile(new URL("../../../frontend/chat/src/mobile-pairing-dialog.tsx", import.meta.url), "utf8");
const controller = await readFile(new URL("../../../frontend/chat/src/use-mobile-pairing.ts", import.meta.url), "utf8");
