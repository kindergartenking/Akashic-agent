...
import { StreamProjectionStore } from "../../../frontend/chat/src/stream-projection.ts";
import { canProjectWebStreamWithoutRoot, publishWebStreamChanges } from "../../../frontend/chat/src/web-stream-projection.ts";
