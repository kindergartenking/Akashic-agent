...
import { createConnectionDraft, groupConnections } from "../../../frontend/chat/src/settings-data.ts";

const app = await readFile(new URL("../../../frontend/chat/src/settings-app.tsx", import.meta.url), "utf8");
const dialog = await readFile(new URL("../../../frontend/chat/src/settings-connection-dialog.tsx", import.meta.url), "utf8");
const connection = await readFile(new URL("../../../frontend/chat/src/use-settings-connection.ts", import.meta.url), "utf8");
