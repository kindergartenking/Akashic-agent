...
import { runtimeItems } from "../../../frontend/chat/src/runtime-dashboard-data.ts";
...
test("runtime controller derives selection before detail effects", async () => {
  const controller = await readFile(new URL("../../../frontend/chat/src/use-runtime-dashboard.ts", import.meta.url), "utf8");
