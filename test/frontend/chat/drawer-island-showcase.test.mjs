...
const source = await readFile(new URL("../../../frontend/chat/src/drawer-island-showcase.tsx", import.meta.url), "utf8");
const css = await readFile(new URL("../../../frontend/chat/src/drawer-island-showcase.css", import.meta.url), "utf8");
const main = await readFile(new URL("../../../frontend/chat/src/main.tsx", import.meta.url), "utf8");
