...
const platformStyles = await readFile(
  new URL("../../../frontend/chat/src/mobile-native.css", import.meta.url),
  "utf8",
);
const sharedStyles = await readFile(
  new URL("../../../frontend/chat/src/message-view.css", import.meta.url),
  "utf8",
);
const themeStyles = await readFile(
  new URL("../../../frontend/chat/src/theme.css", import.meta.url),
  "utf8",
);
const desktopStyles = await readFile(
  new URL("../../../frontend/chat/src/styles.css", import.meta.url),
  "utf8",
);
const dashboardStyles = await readFile(
  new URL("../../../frontend/dashboard/src/styles.css", import.meta.url),
  "utf8",
);
const desktopSource = await readFile(
  new URL("../../../frontend/chat/src/desktop-chat-view.tsx", import.meta.url),
  "utf8",
);
const desktopAppSource = await readFile(
  new URL("../../../frontend/chat/src/desktop-chat-app.tsx", import.meta.url),
  "utf8",
);
const desktopControllerSource = await readFile(
  new URL("../../../frontend/chat/src/use-desktop-chat-controller.ts", import.meta.url),
  "utf8",
);
const desktopConversationSource = await readFile(
  new URL("../../../frontend/chat/src/desktop-conversation.tsx", import.meta.url),
  "utf8",
);
const desktopSidebarSource = await readFile(
  new URL("../../../frontend/chat/src/desktop-sidebar.tsx", import.meta.url),
  "utf8",
);
const mobileSource = await readFile(
  new URL("../../../frontend/chat/src/mobile-native.tsx", import.meta.url),
  "utf8",
);
const pluginRuntimeSource = await readFile(
  new URL("../../../frontend/chat/src/mobile-plugin-runtime.tsx", import.meta.url),
  "utf8",
);
const sharedMessageSource = await readFile(
  new URL("../../../frontend/chat/src/message-view.tsx", import.meta.url),
  "utf8",
);
const navigationSource = await readFile(
  new URL("../../../frontend/chat/src/conversation-navigation.tsx", import.meta.url),
  "utf8",
);
const navigationStyles = await readFile(
  new URL("../../../frontend/chat/src/conversation-navigation.css", import.meta.url),
  "utf8",
);
const runtimeDashboardSource = await readFile(
  new URL("../../../frontend/chat/src/runtime-dashboard.tsx", import.meta.url),
  "utf8",
);
const runtimeDashboardStyles = await readFile(
  new URL("../../../frontend/chat/src/runtime-dashboard.css", import.meta.url),
  "utf8",
);
