...
const app = await readFile(new URL("../../../frontend/chat/src/desktop-chat-view.tsx", import.meta.url), "utf8");
const controller = await readFile(new URL("../../../frontend/chat/src/use-desktop-chat-controller.ts", import.meta.url), "utf8");
const mobileNavigation = await readFile(new URL("../../../frontend/chat/src/desktop-mobile-navigation.tsx", import.meta.url), "utf8");
const sidebar = await readFile(new URL("../../../frontend/chat/src/desktop-sidebar.tsx", import.meta.url), "utf8");
const navigation = await readFile(new URL("../../../frontend/chat/src/conversation-navigation.tsx", import.meta.url), "utf8");
const mobile = await readFile(new URL("../../../frontend/chat/src/mobile-native.tsx", import.meta.url), "utf8");
