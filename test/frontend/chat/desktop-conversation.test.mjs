...
const conversation = await readFile(new URL("../../../frontend/chat/src/desktop-conversation.tsx", import.meta.url), "utf8");
const messageView = await readFile(new URL("../../../frontend/chat/src/message-view.tsx", import.meta.url), "utf8");
const styles = await readFile(new URL("../../../frontend/chat/src/styles.css", import.meta.url), "utf8");
const conversationShell = await readFile(new URL("../../../frontend/chat/src/components/ai-elements/conversation.tsx", import.meta.url), "utf8");
const desktopApp = await readFile(new URL("../../../frontend/chat/src/desktop-chat-view.tsx", import.meta.url), "utf8");
const desktopAutoScroll = await readFile(new URL("../../../frontend/chat/src/desktop-auto-scroll.tsx", import.meta.url), "utf8");
...
test("shared message contracts no longer import the desktop entry", async () => {
  ...
  ].map((path) => readFile(new URL(`../../../frontend/chat/src/${path}`, import.meta.url), "utf8")));
