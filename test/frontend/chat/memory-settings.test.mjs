...
const view = await readFile(new URL("../../../frontend/chat/src/memory-settings.tsx", import.meta.url), "utf8");
const dialog = await readFile(new URL("../../../frontend/chat/src/memory-embedding-dialog.tsx", import.meta.url), "utf8");
const controller = await readFile(new URL("../../../frontend/chat/src/use-memory-settings.ts", import.meta.url), "utf8");
const data = await readFile(new URL("../../../frontend/chat/src/memory-settings-data.ts", import.meta.url), "utf8");
