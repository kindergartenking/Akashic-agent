...
const catalog = JSON.parse(await readFile(new URL("../../../frontend/theme/src/theme-catalog.json", import.meta.url), "utf8"));
const runtime = await readFile(new URL("../../../frontend/theme/src/theme-runtime.ts", import.meta.url), "utf8");
